...
//        
        ...
        for (int i = 0; i < numReg; i++) {
            ...
            columna[2] = Prod.listProduct().get(i).getPrecio();
            columna[3] = Prod.listProduct().get(i).getCantidad();
            columna[4] = Prod.listProduct().get(i).getPresentacion();
            columna[5] = Prod.listProduct().get(i).getNombreP();
 ...
 public void pasarDatos_CajaTexto(JTable tablaD) {
        ...
        txtPrecio.setText(tablaD.getModel().getValueAt(fila, 2).toString());
        txtCantidad.setText(tablaD.getModel().getValueAt(fila, 3).toString());
        txtPresentacion.setText(tablaD.getModel().getValueAt(fila, 4).toString());
        cmbProveedor.setSelectedItem(tablaD.getModel().getValueAt(fila, 5).toString());
    }
 ...
 public void OrdenarIdA() {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Producto1.jpg"))); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(txtPresentacion, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
       ...
       String NombreP = (String) cmbProveedor.getSelectedItem();
        ...
        if (txtNombre.getText().equals("") || txtClave.getText().equals("") ||txtPrecio.getText().equals("") || txtCantidad.getText().equals("")||txtPresentacion.getText().equals("") ) {
            JOptionPane.showMessageDialog(null, "Hay campos vacios, debe de llenar todos los campos");
        } else {
        
       Prod.GuardarProducto(Nombre, Clave, Precio, Cantidad, Presentacion, NombreP);
        limpiarCajas();
